    ...
    <div class="container">
      <div class="row box-intro">
        <div class="col-md-6 col-lg-5 col-xl-4">
          ...
          <p class="description">Một nơi làm việc tuyệt vời dành những người xuất sắc thích thử thách trong công việc</p>
      ...
      <div class="row">
        <div class="col-md-5 box-text">
          ...
          Các mô hình lớp học tiếng Anh truyền thống chỉ cung cấp cho bạn những kiến thức cơ bản, nhưng lại thiếu môi trường thực hành.
            ...
            <br /><br />
            Hãy luôn tin rằng, bạn hoàn toàn có thể nói tiếng Anh lưu loát mà không cần giỏi ngữ pháp"</p>
        </div>
      ...
      <div class="box-wrapper">
        <div class="row align-items-center">
          <div class="box-text col-md-5">
            ...
            <p class="des">Bituer là những người đam mê, sáng tạo và luôn tập trung vào sứ mệnh giúp mọi người nói tiếng Anh tốt hơn.</p>
            <button type="submit" class="btn btn-orange btn-advisory"><span>Gia nhập với chúng tôi</span></button>
          </div>
