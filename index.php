  ...
  <div class="main-body">
    <div class="con-intro">
      <div class="container">
        ...
        <h3 class="title-lg">App luyện nói tiếng Anh với <br /> <span class="text-primary">100% người nước ngoài</span></h3>
        ...
        <form class="register-form-common">
          ...
          <div class="form-group">
            <div class="form-control-with-pre-icon">
              ...
              <svg class="ic" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.4117 6.07523C14.4117 8.52275 12.4493 10.4853 10 10.4853C7.55162 10.4853 5.58838 8.52275 5.58838 6.07523C5.58838 3.6277 7.55162 1.66602 10 1.66602C12.4493 1.66602 14.4117 3.6277 14.4117 6.07523ZM9.99992 18.3327C6.38523 18.3327 3.33325 17.7452 3.33325 15.4785C3.33325 13.211 6.4044 12.6443 9.99992 12.6443C13.6154 12.6443 16.6666 13.2318 16.6666 15.4985C16.6666 17.766 13.5954 18.3327 9.99992 18.3327Z" fill="url(#paint0_linear_1365_4165)"/><defs><linearGradient id="paint0_linear_1365_4165" x1="3.33325" y1="1.66602" x2="18.3237" y2="3.57764" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6D03"/><stop offset="1" stop-color="#FF9A03"/></linearGradient></defs></svg>
            </div>
          </div>
    ...
    <div class="con-reason-speaking">
      <div class="container">
        <h3 class="title-lg">Hiểu tiếng Anh, nhưng <span class="text-primary">không nói được?</span></h3>

        <div class="box-img mx-auto">
          <img src="images/reason-speaking.png" alt="Hiểu tiếng Anh, nhưng không nói được?" class="img-big w-100">
        </div>
      </div>
    </div>
    ...
    <div class="con-reason-reflex">
      <div class="container">
        ...
        <div class="box-btn text-center">
          <button class="btn btn-orange"><span>Nhận tư vấn miễn phí</span></button>
        </div>
      </div>
    </div>
        ...
        <div class="box-wrapper">
          ...
          <div class="box-slider-wrapper">
            <div class="box-slider-pc d-none d-sm-block">
              ...
              <button type="button" class="slick-prev slick-arrow" role="button">
                <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.8098 3L8.10063 11.576C8.04403 11.6317 7.99912 11.6977 7.96848 11.7705C7.93785 11.8433 7.92208 11.9212 7.92208 12C7.92208 12.0788 7.93785 12.1567 7.96848 12.2295C7.99912 12.3023 8.04403 12.3683 8.10063 12.424L16.8098 21" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
              </button>
              <button type="button" class="slick-next slick-arrow" role="button">
            ...
            <div class="box-slider-mobile d-block d-sm-none">
            <div class="box-slider">
                <div class="slide-item">
                  <div class="box-moderator">
                    <div class="photo"><img src="images/kevin.png" alt="Kevin" class="w-100"></div>
      ...
      <div class="box-slider-wrapper">
        <div class="container">
          <div class="box-slider-pc d-none d-sm-block">
            ...
            <button type="button" class="slick-prev slick-arrow d-none d-sm-flex" role="button">
              <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.8098 3L8.10063 11.576C8.04403 11.6317 7.99912 11.6977 7.96848 11.7705C7.93785 11.8433 7.92208 11.9212 7.92208 12C7.92208 12.0788 7.93785 12.1567 7.96848 12.2295C7.99912 12.3023 8.04403 12.3683 8.10063 12.424L16.8098 21" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </button>
            <button type="button" class="slick-next slick-arrow d-none d-sm-flex" role="button">
              <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.19043 3L17.8996 11.576C17.9562 11.6317 18.0011 11.6977 18.0318 11.7705C18.0624 11.8433 18.0782 11.9212 18.0782 12C18.0782 12.0788 18.0624 12.1567 18.0318 12.2295C18.0011 12.3023 17.9562 12.3683 17.8996 12.424L9.19043 21" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </button>
          </div>
          ...
          <li class="list-group-item">
            <div class="row">
              ...
              <div class="col-md-3 box-logo">
               <p class="img"> <img src="images/logo_vnexpress.png" alt=""></p>
              </div>
            </div>
          </li>
          <li class="list-group-item">
            <div class="row">
              ...
              <div class="col-md-3 box-logo">
                <p class="img"><img src="images/logo_vietnamnet.png" alt=""></p>
              </div>
            </div>
          </li>
        </ul>
  ...
  <script>
    var viewportWidth = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
      ...
      $(function() {
        ...
        // Mobile
        $('.con-effective .box-slider-mobile .box-slider').slick({
          speed: 600,
          autoplaySpeed: 6000,
          autoplay: true,
          infinite: true,
      ...
      /* -----------------------------------------------------------
        Register advisory - youtube modal
      ----------------------------------------------------------- */
      $(function() {
      ...
      $(function() {
        ...
        $('.con-moderators .slick-prev').on('click', function() {
        ...
        // Mobile
        $('.con-moderators .box-slider-mobile .box-slider').slick({
          speed: 600,
          autoplaySpeed: 6000,
          autoplay: true,
          infinite: true,
      ...
      /* -----------------------------------------------------------
        Newsbitu slider
      ----------------------------------------------------------- */
      $('.con_newsbitu .box-slider-mobile .box-slider').slick({
          speed: 600,
          autoplaySpeed: 6000,
          autoplay: true,
          infinite: true,
